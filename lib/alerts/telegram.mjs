...
const TIER_CONFIG = {
  FLASH:    { emoji: '🔴', label: 'FLASH',    cooldownMs: 5 * 60 * 1000,  maxPerHour: 16 },
  PRIORITY: { emoji: '🟡', label: 'PRIORITY', cooldownMs: 30 * 60 * 1000, maxPerHour: 14 },
  ROUTINE:  { emoji: '🔵', label: 'ROUTINE',  cooldownMs: 60 * 60 * 1000, maxPerHour: 12 },
};
...
## Output Format
Responde SIEMPRE en ESPAÑOL el contenido de los campos "headline","reason", "actionable" y crossCorrelation" el resto tal y como se describe debajo
